...
dataset = LINCSDataset(gctx_path="../data/processed/LINCS.gctx", normalize="z-score", feature_space="landmark", nrows=1000)
runner = TFInferenceRunner(methods=["viper"], consensus=False, min_n=1)
